package com.nix.vyrvykhvost.util.parsers;
...
public class Xml {
    ...
    public static List<String> toLines(InputStream jsonInputStream) {
    ...
    public static Map<String, String> linesToMap(List<String> lines) {
